...
$pagetitle = "Новая заявка с сайта \"$sitename\"";
$message = "Имя: $name <br> Телефон: $phone <br> Email: $email <br> Область: $region <br> Город: $city <br> Адресс: $address <br> Комментарий: $area <br> ИНФОРМА́ЦИЯ: <br> $info";


$headers= "MIME-Version: 1.0\r\n";
$headers .= "Content-type: text/html; charset=utf-8\r\n"; 	// кодировка письма
$headers .= "From: okcoffee <info@okcoffee.com.ua>\r\n";   			// от кого письмо
$result =  $mailSMTP->send($recepient, $pagetitle, $message, $headers);
